...
ratings= pd.read_csv('dane/ratings.csv',encoding='latin-1')
movies = pd.read_csv('dane/movies.csv',encoding='latin-1')
tags = pd.read_csv('dane/tags.csv',encoding='latin-1')
